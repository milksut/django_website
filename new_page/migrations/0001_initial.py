# Generated by Django 4.0.10 on 2024-05-20 18:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(max_length=600, verbose_name='Yorum')),
            ],
        ),
        migrations.CreateModel(
            name='Kupon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CoachLeague', models.CharField(max_length=50, verbose_name='Lig Uzmanligi')),
                ('Coachİmage', models.ImageField(upload_to='static/pictures', verbose_name='')),
